...
<title>Nikola Tesla - Actualizar Matricula</title>
...
<body>
	...
	<%
		MatriculaDTO mat = (MatriculaDTO) request.getAttribute("matricula");
	%>
                ...
                <main>
                    <div class="container-fluid px-0">
						...
						<div class="container mb-5">
							<h3 class="text-center mt-3 text-white font-opensans">Actualizar Matricula ID: <%=mat.getNumMatricula() %></h3>
							...
							<div class="row justify-content-center">
								...
								<form action="ServletMatricula" method="post" class="col-10 col-sm-8 col-md-6 col-xl-5 bg-light p-4 border border-1 rounded shadow mt-4 font-opensans">
									...
									<input type="hidden" name="txtCod" value="<%= mat.getNumMatricula() %>">
									
									<div class="mb-4 row">
									
										<label for="txtFec" class="col-sm-4 col-form-label mb-2">Fecha:</label>
										<div class="col-sm-8">
											<input value="<%= mat.getFecMatricula() %>"

...
<title>Nikola Tesla - Registrar Administrador</title>
                ...
                <main>
                    <div class="container-fluid px-0">
						...
						<div class="container mb-5">
							<h3 class="text-center mt-3 text-white font-opensans">REGISTRO DE ADMINISTRADOR</h3>
							...
							<div class="row justify-content-center">
								...
								<form action="ServletAdministrador" method="post" class="col-10 col-sm-8 col-md-6 col-xl-5 bg-light p-4 border border-1 rounded shadow mt-4 font-opensans">
									<div class="mb-4 row">
										...
										<label for="txtEma" class="col-sm-4 col-form-label mb-2">Email:</label>
										<div class="col-sm-8">

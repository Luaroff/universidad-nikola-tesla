...
<title>Nikola Tesla - Actualizar Estudiante</title>
...
<body>
	...
	<%
		EstudianteDTO obj = (EstudianteDTO) request.getAttribute("estudiante");
	%>
                ...
                <main>
                    <div class="container-fluid px-0">
						...
						<div class="container mb-5">
							<h3 class="text-center mt-3 text-white font-opensans">Actualizar Estudiante ID: <%=obj.getIdeEst() %></h3>
							<div style="width: 10rem; background-color:rgb(159, 121, 68); height:0.25rem; margin: auto;"></div>
							<div class="row justify-content-center">

								<form action="ServletEstudiante" method="post" class="col-10 col-sm-8 col-md-6 col-xl-5 bg-light p-4 border border-1 rounded shadow mt-4 font-opensans">
									
									<input type="hidden" name="txtCod" value="<%= obj.getIdeEst() %>">
									
									<div class="mb-4 row">
										<label for="txtNom" class="col-sm-4 col-form-label mb-2">Nombres:</label>
										<div class="col-sm-8">
											<input value="<%= obj.getNomEst() %>" type="text" pattern="^[A-Za-zÁ-Úá-úÄ-Üä-ü ]{2,20}$"
										...
										<div class="col-sm-8">
											<input value="<%= obj.getApeEst() %>" type="text" pattern="^[A-Za-zÁ-Úá-úÄ-Üä-ü ]{2,20}$"
												title="El nombre debe ser de 2 a 20 letras"
									...
									<div class="text-center">
										...
										<a class="btn btn-success" href="ServletEstudiante?tipo=listar">

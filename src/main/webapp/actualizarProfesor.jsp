...
<title>Nikola Tesla - Actualizar Profesor</title>
                ...
                <main>
                    <div class="container-fluid px-0">
						...
						<div class="container mb-5">
							<h3 class="text-center mt-3 text-white font-opensans">Actualizar Profesor ID: <%= prof.getIdepro() %></h3>
							...
							<div class="row justify-content-center">
								...
								<form action="ServletProfesor" method="post" class="col-10 col-sm-8 col-md-6 col-xl-5 bg-light p-4 border border-1 rounded shadow mt-4 font-opensans">
									...
									<input type="hidden" name="txtCod" value="<%= prof.getIdepro() %>">
									
									<div class="mb-4 row">
										<label for="txtNom" class="col-sm-4 col-form-label mb-2">Nombres:</label>
										<div class="col-sm-8">
											<input value="<%= prof.getNompro() %>" type="text" pattern="^[A-Za-zÁ-Úá-úÄ-Üä-ü ]{2,20}$"
										...
										<div class="col-sm-8">
											<input value="<%= prof.getApepro() %>" type="text" pattern="^[A-Za-zÁ-Úá-úÄ-Üä-ü ]{2,20}$"
												title="El nombre debe ser de 2 a 20 letras"

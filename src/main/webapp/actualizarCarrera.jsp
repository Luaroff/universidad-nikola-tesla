...
<title>Nikola Tesla - Actualizar Carrera</title>
...
<body>
	...
	<!-- busquedaMateria -->
	<%
		CarreraDTO objCar = (CarreraDTO) request.getAttribute("carrera");
	%>
                ...
                <main>
                    <div class="container-fluid px-0">
						...
						<div class="container mb-5">
							<h3 class="text-center mt-3 text-white font-opensans">Actualizar Carrera ID: <%=objCar.getIdeCarrera()%></h3>
							<div style="width: 10rem; background-color:rgb(159, 121, 68); height:0.25rem; margin: auto;"></div>
							<div class="row justify-content-center">
								<form action="ServletCarrera" method="post" class="col-10 col-sm-8 col-md-7 col-xl-5 bg-light p-4 border border-1 rounded shadow mt-4 font-opensans">
									<input type="hidden" name="txtCod" value="<%= objCar.getIdeCarrera() %>">
									
			            			<!-- 
									<div class="mb-3 row">
										<label for="txtCod" class="col-sm-4 col-form-label">Codigo</label>
										<div class="col-sm-8">
											<input value="  objMateria.getIdMateria() " type="text"
												class="form-control" id="txtCod" name="txtCod" disabled>
										</div>
									</div>
			            			 -->
									
									<div class="mb-4 row">
										<label for="txtDes" class="col-sm-4 col-form-label">Descripcion:</label>
										<div class="col-sm-8">
											<input value="<%= objCar.getDesCarrera() %>" type="text"
									...
									<div class="text-center">
										...
										<a class="btn btn-success" href="ServletCarrera?tipo=listar">

...
<title>Nikola Tesla - Carreras</title>
...
<body>
	...
	<!-- listadoMaterias -->
	<%
		List<CarreraDTO> data = (List<CarreraDTO>) request.getAttribute("data");
							...
							<!-- tblTabla -->
								<table id="dataTablesES" class="table table-light table-striped container-sm p-0 mb-4">
									...
									<tbody>
										<%
										if (data != null) {
											for (CarreraDTO obj : data) {
										%>
										<tr>
											<td class="text-center col-2"><%=obj.getIdeCarrera()%></td>
											<td class="text-center col-2"><%=obj.getDesCarrera()%></td>
											<td class="text-center col-2">
												<!-- btnActualizar --> 
												<a href="ServletCarrera?tipo=buscar&cod=<%= obj.getIdeCarrera() %>" style="text-decoration:none;">
												...
												<!-- btnEliminar --> 
												<a href="ServletCarrera?tipo=eliminar&cod=<%= obj.getIdeCarrera() %>" style="text-decoration:none;">

...
<title>Nikola Tesla - Actualizar Administrador</title>
...
<body>
	...
	<%
		AdministradorDTO admin = (AdministradorDTO) request.getAttribute("administrador");
	%>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-0">
                        <div class="card my-2 mx-2 border-0" style="background-color: #232323;">

            			<!-- formularioRegistroMateria -->
						<div class="container mb-5">
							<h3 class="text-center mt-3 text-white font-opensans">Actualizar Administrador ID: <%=admin.getIdAdmin() %></h3>
							<div style="width: 10rem; background-color:rgb(159, 121, 68); height:0.25rem; margin: auto;"></div>
							<div class="row justify-content-center">

								<form action="ServletAdministrador" method="post" class="col-10 col-sm-8 col-md-6 col-xl-5 bg-light p-4 border border-1 rounded shadow mt-4 font-opensans">
									
									<input type="hidden" name="txtCod" value="<%= admin.getIdAdmin() %>">
									
									<div class="mb-4 row">
										<label for="txtNom" class="col-sm-4 col-form-label mb-2">Nombres:</label>
										<div class="col-sm-8">
											<input value="<%= admin.getNomAdmin() %>" type="text" pattern="^[A-Za-zÁ-Úá-úÄ-Üä-ü ]{2,20}$"
												title="El nombre debe ser de 2 a 20 letras"
												class="form-control" id="txtNom" name="txtNom">
										</div>
										
										<label for="txtApe" class="col-sm-4 col-form-label mb-2">Apellidos:</label>
										<div class="col-sm-8">
											<input value="<%= admin.getApeAdmin() %>" type="text" pattern="^[A-Za-zÁ-Úá-úÄ-Üä-ü ]{2,20}$"
												title="El nombre debe ser de 2 a 20 letras"
												class="form-control" id="txtApe" name="txtApe">
										</div>
										
										<label for="txtDni" class="col-sm-4 col-form-label mb-2">DNI:</label>
										<div class="col-sm-8">
											<input value="<%= admin.getDniAdmin() %>"  type="text" pattern="[0-9]{8}" maxlength="8" title="Ingrese formato de 8 digitos numericos"
												class="form-control" id="txtDni" name="txtDni">
										</div>
										
										<label for="txtGen" class="col-sm-4 col-form-label mb-2">Genero:</label>
										<div class="col-sm-8">
											<input value="<%= admin.getGenAdmin() %>"  type="text"
												class="form-control" id="txtGen" name="txtGen">
										</div>
										
										<label for="txtFec" class="col-sm-4 col-form-label mb-2">F. Nacimiento:</label>
										<div class="col-sm-8">
											<input value="<%= admin.getFecAdmin() %>"  type="date" pattern="" title=""
												class="form-control" id="txtFec" name="txtFec">
										</div>
										
										<label for="txtEma" class="col-sm-4 col-form-label mb-2">E-mail:</label>
										<div class="col-sm-8">
											<input value="<%= admin.getEmaAdmin() %>"  type="text" class="form-control" id="txtEma" name="txtEma" >
										</div>
										
										<label for="txtTel" class="col-sm-4 col-form-label mb-2">Telefono:</label>
										<div class="col-sm-8">
											<input value="<%= admin.getTelAdmin() %>"  type="text" maxlength="9" title="Ingrese formato de 10 digitos numericos"
												class="form-control" id="txtTel" name="txtTel" required>
										</div>
										
										<label for="txtDir" class="col-sm-4 col-form-label mb-2">Direccion:</label>
										<div class="col-sm-8">
											<input value="<%= admin.getDirAdmin() %>"  type="text"
												class="form-control" id="txtDir" name="txtDir" required>
										</div>
										
										<label for="txtUsu" class="col-sm-4 col-form-label mb-2">Usuario:</label>
										<div class="col-sm-8">
											<input value="<%= admin.getUsuAdmin() %>" type="text" maxlength="10"
												class="form-control" id="txtUsu" name="txtUsu" required>
										</div>
										
										<label for="txtCon" class="col-sm-4 col-form-label mb-2">Contraseña:</label>
										<div class="col-sm-8">
											<input value="<%= admin.getContraAdmin() %>" type="text" maxlength="15"
												class="form-control" id="txtCon" name="txtCon" required>
										</div>
														
									</div>
									<div class="text-center">
										<button class="btn btn-primary me-4" name="tipo" value="actualizar">
											<i class="bi bi-person-plus"></i>Actualizar
										</button>
										<a class="btn btn-success" href="ServletAdministrador?tipo=listar">

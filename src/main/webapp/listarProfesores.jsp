...
<title>Nikola Tesla - Profesores</title>
...
<body>
	...
	<!-- listadoPorfesores-->
	<%
		List<ProfesorDTO> data = (List<ProfesorDTO>) request.getAttribute("data");
	...
	<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
		...
		<div class="m-1"> 
			 ...
			 <a class="text-decoration-none text-white"> Marcelo Luna </a>
		</div>
		...
		<!-- Navegacion_Vertical -->
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-0">
                        <div class="card my-2 mx-2">
				            ...
				            <!-- startTables 
				            					...
				            					ACA IRA TU CODIGO DE LISTAR CREO QUE TU YA LO SABES XD 
                            					MAS BIEN NO OLVIDES QUE ESTE JSP DE LISTARESTUDIATES.JSP 
                            					SE USARA COMO PLANTILLA PARA LAS DEMAS JSP DE LISTAR
							...
							<!-- TablaAlumnos -->
								<table id="dataTablesES"
									class="table table-light table-striped container-sm shadow p-3 mb-4">
	
									<thead class="table-primary">
										<tr>
											<th class="text-center col-1" >IDE</th>
											<th class="text-center col-1">NOMBRE</th>
											<th class="text-center col-2">APELLIDO</th>
											<th class="text-center col-1">DNI</th>
											<th class="text-center col-1">GENERO</th>
											<th class="text-center col-1">NACIMIENTO</th>
											<th class="text-center col-1">EMAIL</th>
											<th class="text-center col-1">TELEFONO</th>
											<th class="text-center col-2">DIRECCION</th>
									...
									<tbody>
										<%
										if (data != null) {
											for (ProfesorDTO obj : data) {
										%>
										<tr>
											<td class="text-center col-1"><%=obj.getIdepro()%></td>
											<td class="text-center col-1"><%=obj.getNompro()%></td>
											<td class="text-center col-2"><%=obj.getApepro()%></td>
											<td class="text-center col-1"><%=obj.getDnipro()%></td>
											<td class="text-center col-1"><%=obj.getGenpro()%></td>
											<td class="text-center col-1"><%=obj.getFecpro()%></td>
											<td class="text-center col-1"><%=obj.getEmapro()%></td>
											<td class="text-center col-1"><%=obj.getTelpro()%></td>
											<td class="text-center col-2"><%=obj.getDirpro()%></td>
											<td class="text-center align-items-center justify-content-evenly">
												<!-- btnActualizar --> <a
												href="ServletProfesor?tipo=buscar&cod=<%=obj.getIdepro()%>" style="text-decoration:none;">
												...
												href="ServletProfesor?tipo=eliminar&cod=<%=obj.getIdepro()%>" style="text-decoration:none;">
													<button type="button" class="btn btn-danger btn-sm">
														<svg xmlns="http://www.w3.org/2000/svg" width="16" height="19" fill="currentColor" class="bi bi-trash3" viewBox="0 0 16 18">
   				...
   				<!-- Pie_De_Pagina -->             
                <footer class="py-4 bg-dark mt-auto mx-2 my-2 bg-radius">

...
<title>Nikola Tesla - Materias</title>
...
<body>
	...
	<!-- listadoMaterias -->
	<%
		List<MateriaDTO> data = (List<MateriaDTO>) request.getAttribute("data");
                ...
                <main>
                    <div class="container-fluid px-0">
                        <div class="card my-2 mx-2">
							...
							<!-- tblTabla -->
								<table id="dataTablesES" class="table table-light table-striped container-sm p-0 mb-4">
									...
									<tbody>
										<%
										if (data != null) {
											for (MateriaDTO obj : data) {
										%>
										<tr>
											<td class="text-center col-2"><%=obj.getIdMateria()%></td>
											<td class="text-center col-2"><%=obj.getDesMateria()%></td>
											<td class="text-center col-2"><%=obj.getDesModalidad()%></td>
											<td class="text-center col-2">
												<!-- btnActualizar --> 
												<a href="ServletMateria?tipo=buscar&cod=<%= obj.getIdMateria() %>" style="text-decoration:none;">
												...
												<!-- btnEliminar --> 
												<a href="ServletMateria?tipo=eliminar&cod=<%= obj.getIdMateria() %>" style="text-decoration:none;">

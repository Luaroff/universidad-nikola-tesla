...
<title>Nikola Tesla - Actualizar Materia</title>
...
<body>
	...
	<!-- busquedaMateria -->
	<%
		MateriaDTO objMateria = (MateriaDTO) request.getAttribute("materia");
	%>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-0">
            			...
            			<!-- formularioActualizarMateria -->
						<div class="container mb-5">
							<h3 class="text-center mt-3 text-white font-opensans">Actualizar Materia ID: <%= objMateria.getIdMateria() %></h3>
							<div style="width: 10rem; background-color:rgb(159, 121, 68); height:0.25rem; margin: auto;"></div>
							<div class="row justify-content-center">
								<form action="ServletMateria" method="post" class="col-10 col-sm-8 col-md-7 col-xl-5 bg-light p-4 border border-1 rounded shadow mt-4 font-opensans">
									<input type="hidden" name="txtCod" value="<%= objMateria.getIdMateria() %>">
									
									<div class="mb-4 row">
										<label for="txtDes" class="col-sm-4 col-form-label mb-2">Descripcion</label>
										<div class="col-sm-8">
											<input value="<%= objMateria.getDesMateria() %>" type="text"
												pattern="^[A-Za-zÁ-Úá-úÄ-Üä-ü ]{5,50}$"
												title="La descripcion debe tener de 5 a 50 letras"
												class="form-control" id="txtDes" name="txtDes">
										</div>
										
										<label for="cboModalidad" class="col-sm-4 col-form-label">Modalidad:</label>
										<div class="col-sm-8">
											<select class="form-select" aria-label="Default select example" name="cboModalidad">
												<%
												List<ModalidadDTO> array = new ArrayList<ModalidadDTO>();
												...
												try{
													...
													ResultSet rs = stm.executeQuery("select * from modalidad");
													while(rs.next()){
												...
												if (array != null)
													for (ModalidadDTO modalidad : array) { %>

											  	<option value="<%=modalidad.getIdeModalidad()%>"><%=modalidad.getDesModalidad()%></option>
									...
									<div class="text-center">
										...
										<a class="btn btn-success" href="ServletMateria?tipo=listar">

...
<title>Nikola Tesla - Administradores</title>
...
<body>
	...
	<%
		List<AdministradorDTO> data = (List<AdministradorDTO>) request.getAttribute("data");
							...
							<!-- TablaAlumnos -->
								<table id="dataTablesES"
									...
									<tbody>
										<%
										if (data != null) {
											for (AdministradorDTO obj : data) {
										%>
										<tr>
											<td class="text-center col-1"><%=obj.getIdAdmin()%></td>
											<td class="text-center col-3"><%=obj.getNomAdmin() + " " +obj.getApeAdmin()%></td>
											<td class="text-center col-1"><%=obj.getDniAdmin()%></td>
											<td class="text-center col-1"><%=obj.getGenAdmin()%></td>
											<td class="text-center col-1"><%=obj.getFecAdmin()%></td>
											<td class="text-center col-1"><%=obj.getEmaAdmin()%></td>
											<td class="text-center col-1"><%=obj.getTelAdmin()%></td>
											<td class="text-center col-3"><%=obj.getDirAdmin()%></td>
											<td class="text-center col-1"><%=obj.getUsuAdmin()%></td>
											<td class="text-center col-1"><%=obj.getContraAdmin()%></td>
											<td class="text-center">
												<!-- btnActualizar --> 
												<a href="ServletAdministrador?tipo=buscar&cod=<%= obj.getIdAdmin() %>" style="text-decoration:none;">
												...
												<!-- btnEliminar --> 
												<a href="ServletAdministrador?tipo=eliminar&cod=<%=obj.getIdAdmin()%>" style="text-decoration:none;">

...
<body>
	...
	<%
		List<ContratoDTO> data = (List<ContratoDTO>) request.getAttribute("data");
							...
							<!-- TablaAlumnos -->
								<table id="dataTablesES"
									...
									<thead class="table-primary">
										<tr>
											<th class="text-center col-1">NÚMERO</th>
											<th class="text-center col-2">FECHA</th>
											<th class="text-center col-2">ADMINISTRADOR</th>
											<th class="text-center col-2">PROFESOR</th>
											<th class="text-center col-2">SUELDO</th>
									...
									<tbody>
										<%
										if (data != null) {
											for (ContratoDTO obj : data) {
										%>
										<tr>
											<td class="text-center col-1"><%=obj.getCodContrato()%></td>
											<td class="text-center col-2"><%=obj.getFecContrato() %></td>
											<td class="text-center col-2"><%=obj.getNomAdministrador()%></td>
											<td class="text-center col-2"><%=obj.getNomProfesor()%></td>
											<td class="text-center col-2">S/. <%=obj.getSueContrato()%></td>
											<td class="text-center col-1">
												<!-- btnActualizar --> 
												<a href="ServletContrato?tipo=buscar&cod=<%= obj.getCodContrato() %>" style="text-decoration:none;">
												...
												<!-- btnEliminar --> 
												<a href="ServletContrato?tipo=eliminar&cod=<%=obj.getCodContrato()%>" style="text-decoration:none;">

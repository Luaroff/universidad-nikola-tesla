...
<title>Nikola Tesla - Registrar Materia</title>
                ...
                <main>
                    <div class="container-fluid px-0">
						...
						<div class="container mb-5">
							<h3 class="text-center mt-3 text-white font-opensans">REGISTRO DE MATERIA</h3>
							<div style="width: 10rem; background-color:rgb(159, 121, 68); height:0.25rem; margin: auto;"></div>
							<div class="row justify-content-center">

								<form action="ServletMateria" method="post" class="col-10 col-sm-8 col-md-6 col-xl-5 bg-light p-4 border border-1 rounded shadow mt-4 font-opensans">
									<div class="mb-4 row">
									
										<label for="txtDes" class="col-sm-4 col-form-label mb-2">Descripcion:</label>
										<div class="col-sm-8">
											<input type="text" pattern="^[A-Za-zÁ-Úá-úÄ-Üä-ü ]{2,20}$"
												title="El nombre debe ser de 2 a 20 letras"
												class="form-control" id="txtDescripcion" name="txtDescripcion" required>
										</div>

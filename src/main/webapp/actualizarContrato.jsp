...
<body>
	...
	<%
		ContratoDTO con = (ContratoDTO) request.getAttribute("contrato");
	%>
                ...
                <main>
                    <div class="container-fluid px-0">
						...
						<div class="container mb-5">
							<h3 class="text-center mt-3 text-white font-opensans">ACTUALIZACION DE CONTRATO</h3>
							<div style="width: 10rem; background-color:rgb(159, 121, 68); height:0.25rem; margin: auto;"></div>
							<div class="row justify-content-center">

								<form action="ServletContrato" method="post" class="col-10 col-sm-8 col-md-6 col-xl-5 bg-light p-4 border border-1 rounded shadow mt-4 font-opensans">
									
									<input type="hidden" name="txtCod" value="<%= con.getCodContrato() %>">
									
									<div class="mb-4 row">
									
										<label for="txtFec" class="col-sm-4 col-form-label mb-2">Fecha:</label>
										<div class="col-sm-8">
											<input value="<%= con.getFecContrato() %>" type="date"
										...
										<label for="cboPro" class="col-sm-4 col-form-label mb-2">Profesor:</label>
										<div class="col-sm-8">
											<select class="form-select" aria-label="Default select example" name="cboPro">
												<%
												List<ProfesorDTO> profes = new ArrayList<ProfesorDTO>();
												ProfesorDTO objpro = null;
												...
												try{
													...
													while(rs.next()){
														objpro = new ProfesorDTO();
														objpro.setIdepro(rs.getInt(1));
														objpro.setNompro(rs.getString(2));
														profes.add(objpro);
													}
													cn.close();
													stm.close();
												...
												if (profes != null)
													for (ProfesorDTO objests : profes) { %>

											  	<option value="<%=objests.getIdepro()%>"><%=objests.getNompro()%></option>
										...
										<label for="txtSue" class="col-sm-4 col-form-label mb-2">Sueldo:</label>
										<div class="col-sm-8">
											<input type="number"
												title="Ingresa un numero con dos decimales"
												class="form-control" id="txtSue" name="txtSue" step="0.01" value="<%= con.getSueContrato()%>" required>
										</div>
									...
									<div class="text-center">
										...
										<a class="btn btn-success" href="ServletContrato?tipo=listar">

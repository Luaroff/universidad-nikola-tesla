...
<title>Nikola Tesla - Registrar Contrato</title>
                ...
                <main>
                    <div class="container-fluid px-0">
						...
						<div class="container mb-5">
							<h3 class="text-center mt-3 text-white font-opensans">REGISTRO DE CONTRATO</h3>
									...
									<div class="mb-4 row">
										...
										<div class="col-sm-8">
											<input type="number"
												...
												class="form-control" id="txtSue" name="txtSue" step="0.01" required>
										</div>

...
<title>Nikola Tesla - Registrar Carrera</title>
                ...
                <main>
                    <div class="container-fluid px-0">
						...
						<div class="container mb-5">
							<h3 class="text-center mt-3 text-white font-opensans">REGISTRO DE CARRERA</h3>
							<div style="width: 10rem; background-color:rgb(159, 121, 68); height:0.25rem; margin: auto;"></div>
							<div class="row justify-content-center">

								<form action="ServletCarrera" method="post" class="col-10 col-sm-8 col-md-6 col-xl-5 bg-light p-4 border border-1 rounded shadow mt-4 font-opensans">
									<div class="mb-4 row">
										<label for="txtDes" class="col-sm-4 col-form-label">Nueva Carrera::</label>
										<div class="col-sm-8">

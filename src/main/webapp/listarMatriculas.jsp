...
<title>Nikola Tesla - Matriculas</title>
...
<body>
	...
	<%
		List<MatriculaDTO> data = (List<MatriculaDTO>) request.getAttribute("data");
								...
								<table id="dataTablesES"
									...
									<thead class="table-primary">
										<tr>
											...
											<th class="text-center col-2">CARRERA</th>
											<th class="text-center col-1">TURNO</th>
											<th class="text-center col-1">SEDE</th>
									...
									<tbody>
										<%
										if (data != null) {
											for (MatriculaDTO obj : data) {
										%>
										<tr>
											<td class="text-center col-1"><%=obj.getNumMatricula()%></td>
											<td class="text-center col-1"><%=obj.getFecMatricula()%></td>
											<td class="text-center col-1"><%=obj.getNomEstudiante()%></td>
											<td class="text-center col-2"><%=obj.getNomCarrera()%></td>
											<td class="text-center col-1"><%=obj.getNomTurno()%></td>
											<td class="text-center col-1"><%=obj.getNomSede()%></td>
											<td class="text-center col-1">
												<!-- btnActualizar --> 
												<a href="ServletMatricula?tipo=buscar&cod=<%= obj.getNumMatricula() %>" style="text-decoration:none;">
												...
												<!-- btnEliminar --> 
												<a href="ServletMatricula?tipo=eliminar&cod=<%=obj.getNumMatricula()%>" style="text-decoration:none;">
